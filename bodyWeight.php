...
if (isset($_POST['search'])) {
    ...
    switch ($searchType) {
        case 'weight':
            $query = "SELECT * FROM bodyWeight WHERE custId = '$custId' AND weight = '$searchValue' ORDER BY recordDate DESC";
            break;
        case 'date':
            $query = "SELECT * FROM bodyWeight WHERE custId = '$custId' AND recordDate = '$searchValue' ORDER BY recordDate DESC";
            break;
        case 'last_week':
            ...
            $query = "SELECT * FROM bodyWeight WHERE custId = '$custId' AND recordDate BETWEEN '$startOfLastWeek' AND '$endOfLastWeek' ORDER BY recordDate DESC";
            break;
        case 'last_month':
            ...
            $query = "SELECT * FROM bodyWeight WHERE custId = '$custId' AND recordDate BETWEEN '$startOfLastMonth' AND '$endOfLastMonth' ORDER BY recordDate DESC";
            break;
        default:
            $query = "SELECT * FROM bodyWeight WHERE custId = '$custId' ORDER BY recordDate DESC";
    }
} else {
    $query = "SELECT * FROM bodyWeight WHERE custId = '$custId' ORDER BY recordDate DESC";
}
